...
special_groups = {
    'conjugated': [
        ...
        ((0, ), '[*]#[*]',),
        ((0, ), 'a:a',),
        ((0, ), '[C;X4;!$([CX4][F,Cl,Br,I,OH])]-[*]=[*]',),
        ((0, ), '[C;X4;!$([CX4][F,Cl,Br,I,OH])]-[*]#[*]',),
        ((0, ), '[C;X4;!$([CX4][F,Cl,Br,I,OH])]-[*]:a',)
    ],
    'functional': [
        # special groups
        (range(7), 'CC(=O)CC(=O)O',),
...
def get_special_groups(mol, include_special_groups):
    ...
    # Define templates
    group_templates = []
    for group in include_special_groups:
        group_templates += special_groups[group]
    ...
    for (add_if_match, template) in group_templates:
        ...
        for match in matches:
            ...
            included_groups.append((add_if, match, template))
